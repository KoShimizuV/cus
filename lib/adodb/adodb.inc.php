...
*/
	...
	var $database = 'nsd99M5a';			/// Name of database to be used.	
	var $host = 'mysql'; 			/// The hostname of the database server	
	var $user = 'nsd99M5a'; 			/// The username which is used to connect to the database server. 
	var $password = '8N84h44k'; 		/// Password for the username. For security, we no longer store it.
